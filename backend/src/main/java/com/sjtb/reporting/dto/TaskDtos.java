...
public final class TaskDtos {
    ...
    public record Response(Long id, String name, Long templateId, String templateName, Long templateVersionId, int templateVersionNo, String frequency, String periodLabel,
                           LocalDateTime startAt, LocalDateTime deadline, boolean allowLate, String status, String description, String sourceType, Long scheduleId, List<Long> assigneeIds,
                           List<Assignee> assignees, List<Long> departmentIds, Progress progress, DetailProgress detailProgress) { }
    ...
    public record DetailProgress(String scope, long totalRows, long draftRows, long submittedRows, long returnedRows, long approvedRows, LocalDateTime lastUpdatedAt) { }
    public record DetailProgressAggregation(Long taskId, long totalRows, long draftRows, long submittedRows, long returnedRows, long approvedRows, LocalDateTime lastUpdatedAt) { }
