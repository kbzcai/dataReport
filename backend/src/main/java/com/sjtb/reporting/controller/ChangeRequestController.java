...
public class ChangeRequestController {
    ...
    @PatchMapping("/{id}/approve") @PreAuthorize("hasRole('ADMIN')") public ChangeRequestDtos.Response approve(@PathVariable Long id, @RequestBody(required = false) ChangeRequestDtos.ReviewRequest input) { return service.approve(id, input); }
    @PatchMapping("/{id}/reject") @PreAuthorize("hasRole('ADMIN')") public ChangeRequestDtos.Response reject(@PathVariable Long id, @RequestBody(required = false) ChangeRequestDtos.ReviewRequest input) { return service.reject(id, input); }
